...
// read remarks to adapt it to your own problem
   clear
   lines(0);
   rep=get_absolute_file_path("dosatron_filter_example.sce");
   chdir(rep);
//-------------------------------------------
...
//-------------------------------------------------------
//-----------------------------------------------------------------------------------------------
// filtre numerique passe-haut de degre 1 et de cte de temps tau_slope pour extraction pente
//-----------------------------------------------------------------------------------------------
  tau_slope_ech=10; // constante de temps = 10 echantillons
  wn_ech_1=1/tau_slope_ech;
  vn=tan(wn_ech_1*1/2);
  F_of_w=list();
  F_of_w(1)=w/(w+vn); // cel 1
