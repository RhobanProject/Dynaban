...
//-------------------------------------------------------------
   clear
   lines(0);funcprot(0);
   rep=get_absolute_file_path("low_pass_iir_example.sce");
   chdir(rep);
//-------------------------------------------------------------
// FILTER DEFINITION ( MODIFIY AS YOUR CONVENIENCE)
//-------------------------------------------------------------
   stacksize(50000000); // 50MO de pile
//-------------------------------------------------
...
//---------------------------------------------------
  f0=500; // Low Cut Off Frequency f0 (Hz)
  f1=502.5; // Hig Cut Off Frequency f1 (Hz)
  G0_db=20*log10(0.99);  // mininum Gain for f<=f0, decibels
...
//     %inf for Hinfinity norm (max odulus of frequency response)
//-------------------------------------------------------------------
...
//------------------------------------------------------
   params.file_name="low_pass"; // will generate toto.c,toto_int.c,toto_float.c
//---------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
   params.name_filter="low_pass"; // specifc functions for this filter will end with _Fz
//--------------------------------------------------------------
