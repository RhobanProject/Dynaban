...
architecture Behavioral of RII_exemple is
 ...
 signal opi1_2, tmp_26, tmp_27, tmp_28, tmp_29, i1_2, opi1_2, tmp_34, tmp_35, tmp_36 : signed (19 downto 0) := "00000000000000000000";-- signaux intermediaires sur 20 bits,  niveau 0
 signal tmp_37, i1_2, opi1_3, tmp_60, tmp_61, tmp_62, tmp_63, i1_3, opi1_3, tmp_68 : signed (19 downto 0) := "00000000000000000000";-- signaux intermediaires sur 20 bits,  niveau 0
 signal tmp_69, tmp_70, tmp_71, i1_3, opi1_4, tmp_94, tmp_95, tmp_96, tmp_97, i1_4 : signed (19 downto 0) := "00000000000000000000";-- signaux intermediaires sur 20 bits,  niveau 0
 signal opi1_4, tmp_102, tmp_103, tmp_104, tmp_105, i1_4, opi1_5, tmp_128, tmp_129, tmp_130 : signed (19 downto 0) := "00000000000000000000";-- signaux intermediaires sur 20 bits,  niveau 0
 signal tmp_131, i1_5, opi1_5, tmp_136, tmp_137, tmp_138, tmp_139, i1_5, opi1_6, tmp_162 : signed (19 downto 0) := "00000000000000000000";-- signaux intermediaires sur 20 bits,  niveau 0
 signal tmp_163, tmp_164, tmp_165, i1_6, opi1_6, tmp_170, tmp_171, tmp_172, tmp_173, i1_6 : signed (19 downto 0) := "00000000000000000000";-- signaux intermediaires sur 20 bits,  niveau 0
 signal opi1_7, tmp_196, tmp_197, tmp_198, tmp_199, i1_7, opi1_7, tmp_204, tmp_205, tmp_206 : signed (19 downto 0) := "00000000000000000000";-- signaux intermediaires sur 20 bits,  niveau 0
 signal tmp_207, i1_7 : signed (19 downto 0) := "00000000000000000000";-- signaux intermediaires sur 20 bits,  niveau 0
 ...
 signal tmp_215, tmp_216 : signed (31 downto 0) := "00000000000000000000000000000000";-- signaux intermediaires sur 32 bits,  niveau 0
begin
    ---------------------------------------------------------------------------------------------------------------
    ...
    tmp_4 <= tmp_3 * to_signed(19845,16) ;
    tmp_209 <= shift_right(tmp_4,7) ; -- scale output of cel 1
    -- local output :tmp_209 of cel 1 will be accumulated
    ---------------------------------------------
    -- code of cel 2
    ---------------------------------------------
    tmp_5 <= shift_right(tmp_4,7) ; -- vn<-en<<L ,L=-7
    e_2 <= tmp_5(15 downto 0);
    tmp_4= (int_32)0; -- sn<-0,because D=0 
    -- update state x1_2 of cel 2
    tmp_7 <= e_2 * to_signed(-2161,16) ; -- accx<-b1.vn 
    tmp_8 <= op_x1_2 * to_signed(14848,16) ; -- accx<-accx-a11 . op_x1_2 
    tmp_9 <= tmp_8 + tmp_7 ;
    tmp_10 <= op_x2_2 * to_signed(20546,16) ; -- accx<-accx-a12 . op_x2_2 
    tmp_11 <= tmp_10 + tmp_9 ;
    tmp_12 <= shift_right(tmp_11,14) ; -- accx<-accx >> Lx1 
    x1_2 <= tmp_12(15 downto 0);
    tmp_13 <= op_x1_2 * to_signed(-25322,16) ; -- sn<-sn+C1 . x1_2 
    tmp_14 <= tmp_13 + tmp_4 ;
    -- update state x2_2 of cel 2
    tmp_15 <= e_2 * to_signed(3103,16) ; -- accx<-b2.vn 
    tmp_16 <= op_x2_2 * to_signed(14633,16) ; -- accx<-accx-a22 . op_x2_2 
    tmp_17 <= tmp_16 + tmp_15 ;
    tmp_18 <= op_x1_2 * to_signed(-20492,16) ; -- accx<-accx-a21 . op_x1_2 
    tmp_19 <= tmp_18 + tmp_17 ;
    tmp_20 <= shift_right(tmp_19,14) ; -- accx<-accx >> Lx2 
    x2_2 <= tmp_20(15 downto 0);
    tmp_21 <= op_x2_2 * to_signed(21662,16) ; -- sn<-sn+C2 . x2_2 
    tmp_22 <= tmp_21 + tmp_14 ;
    -- op_x1_2 <- q(x1_2), avec q=(2^-3)/(z-[ 1 - (2^-3) ] )
    ...
    tmp_27<= resize( x1_2 , 20 );
    tmp_28<= resize( op_x1_2 , 20 );
    tmp_29 <= tmp_27 - tmp_28 ;
    i1_2 <= tmp_29 + opi1_2 ;
    tmp_26 <= shift_right(opi1_2,3) ;
    -- op_x2_2 <- q(x2_2), avec q=(2^-3)/(z-[ 1 - (2^-3) ] )
    ...
    tmp_35<= resize( x2_2 , 20 );
    tmp_36<= resize( op_x2_2 , 20 );
    tmp_37 <= tmp_35 - tmp_36 ;
    i1_2 <= tmp_37 + opi1_2 ;
    tmp_34 <= shift_right(opi1_2,3) ;
     -- scale output of cel 2
    -- accumulation of output: tmp_22 of cel 2 with local output: tmp_209
    tmp_210 <= tmp_209 + tmp_22 ;
    ---------------------------------------------
    -- code of cel 3
    ---------------------------------------------
    tmp_39 <= shift_right(tmp_22,6) ; -- vn<-en<<L ,L=-6
    e_3 <= tmp_39(15 downto 0);
    tmp_22= (int_32)0; -- sn<-0,because D=0 
    -- update state x1_3 of cel 3
    tmp_41 <= e_3 * to_signed(8203,16) ; -- accx<-b1.vn 
    tmp_42 <= op_x1_3 * to_signed(15066,16) ; -- accx<-accx-a11 . op_x1_3 
    tmp_43 <= tmp_42 + tmp_41 ;
    tmp_44 <= op_x2_3 * to_signed(20431,16) ; -- accx<-accx-a12 . op_x2_3 
    tmp_45 <= tmp_44 + tmp_43 ;
    tmp_46 <= shift_right(tmp_45,14) ; -- accx<-accx >> Lx1 
    x1_3 <= tmp_46(15 downto 0);
    tmp_47 <= op_x1_3 * to_signed(-26443,16) ; -- sn<-sn+C1 . x1_3 
    tmp_48 <= tmp_47 + tmp_22 ;
    -- update state x2_3 of cel 3
    tmp_49 <= e_3 * to_signed(97,16) ; -- accx<-b2.vn 
    tmp_50 <= op_x2_3 * to_signed(14230,16) ; -- accx<-accx-a22 . op_x2_3 
    tmp_51 <= tmp_50 + tmp_49 ;
    tmp_52 <= op_x1_3 * to_signed(-20484,16) ; -- accx<-accx-a21 . op_x1_3 
    tmp_53 <= tmp_52 + tmp_51 ;
    tmp_54 <= shift_right(tmp_53,14) ; -- accx<-accx >> Lx2 
    x2_3 <= tmp_54(15 downto 0);
    tmp_55 <= op_x2_3 * to_signed(26369,16) ; -- sn<-sn+C2 . x2_3 
    tmp_56 <= tmp_55 + tmp_48 ;
    -- op_x1_3 <- q(x1_3), avec q=(2^-3)/(z-[ 1 - (2^-3) ] )
    ...
    tmp_61<= resize( x1_3 , 20 );
    tmp_62<= resize( op_x1_3 , 20 );
    tmp_63 <= tmp_61 - tmp_62 ;
    i1_3 <= tmp_63 + opi1_3 ;
    tmp_60 <= shift_right(opi1_3,3) ;
    -- op_x2_3 <- q(x2_3), avec q=(2^-3)/(z-[ 1 - (2^-3) ] )
    ...
    tmp_69<= resize( x2_3 , 20 );
    tmp_70<= resize( op_x2_3 , 20 );
    tmp_71 <= tmp_69 - tmp_70 ;
    i1_3 <= tmp_71 + opi1_3 ;
    tmp_68 <= shift_right(opi1_3,3) ;
     -- scale output of cel 3
    -- accumulation of output: tmp_56 of cel 3 with local output: tmp_210
    tmp_211 <= tmp_210 + tmp_56 ;
    ---------------------------------------------
    -- code of cel 4
    ---------------------------------------------
    tmp_73 <= shift_right(tmp_56,5) ; -- vn<-en<<L ,L=-5
    e_4 <= tmp_73(15 downto 0);
    tmp_56= (int_32)0; -- sn<-0,because D=0 
    -- update state x1_4 of cel 4
    tmp_75 <= e_4 * to_signed(6859,16) ; -- accx<-b1.vn 
    tmp_76 <= op_x1_4 * to_signed(16024,16) ; -- accx<-accx-a11 . op_x1_4 
    tmp_77 <= tmp_76 + tmp_75 ;
    tmp_78 <= op_x2_4 * to_signed(19952,16) ; -- accx<-accx-a12 . op_x2_4 
    tmp_79 <= tmp_78 + tmp_77 ;
    tmp_80 <= shift_right(tmp_79,14) ; -- accx<-accx >> Lx1 
    x1_4 <= tmp_80(15 downto 0);
    tmp_81 <= op_x1_4 * to_signed(25423,16) ; -- sn<-sn+C1 . x1_4 
    tmp_82 <= tmp_81 + tmp_56 ;
    -- update state x2_4 of cel 4
    tmp_83 <= e_4 * to_signed(13237,16) ; -- accx<-b2.vn 
    tmp_84 <= op_x2_4 * to_signed(12693,16) ; -- accx<-accx-a22 . op_x2_4 
    tmp_85 <= tmp_84 + tmp_83 ;
    tmp_86 <= op_x1_4 * to_signed(-20622,16) ; -- accx<-accx-a21 . op_x1_4 
    tmp_87 <= tmp_86 + tmp_85 ;
    tmp_88 <= shift_right(tmp_87,14) ; -- accx<-accx >> Lx2 
    x2_4 <= tmp_88(15 downto 0);
    tmp_89 <= op_x2_4 * to_signed(-27341,16) ; -- sn<-sn+C2 . x2_4 
    tmp_90 <= tmp_89 + tmp_82 ;
    -- op_x1_4 <- q(x1_4), avec q=(2^-3)/(z-[ 1 - (2^-3) ] )
    ...
    tmp_95<= resize( x1_4 , 20 );
    tmp_96<= resize( op_x1_4 , 20 );
    tmp_97 <= tmp_95 - tmp_96 ;
    i1_4 <= tmp_97 + opi1_4 ;
    tmp_94 <= shift_right(opi1_4,3) ;
    -- op_x2_4 <- q(x2_4), avec q=(2^-3)/(z-[ 1 - (2^-3) ] )
    ...
    tmp_103<= resize( x2_4 , 20 );
    tmp_104<= resize( op_x2_4 , 20 );
    tmp_105 <= tmp_103 - tmp_104 ;
    i1_4 <= tmp_105 + opi1_4 ;
    tmp_102 <= shift_right(opi1_4,3) ;
     -- scale output of cel 4
    -- accumulation of output: tmp_90 of cel 4 with local output: tmp_211
    tmp_212 <= tmp_211 + tmp_90 ;
    ---------------------------------------------
    -- code of cel 5
    ---------------------------------------------
    tmp_107 <= shift_right(tmp_90,4) ; -- vn<-en<<L ,L=-4
    e_5 <= tmp_107(15 downto 0);
    tmp_90= (int_32)0; -- sn<-0,because D=0 
    -- update state x1_5 of cel 5
    tmp_109 <= e_5 * to_signed(-20056,16) ; -- accx<-b1.vn 
    tmp_110 <= op_x1_5 * to_signed(17297,16) ; -- accx<-accx-a11 . op_x1_5 
    tmp_111 <= tmp_110 + tmp_109 ;
    tmp_112 <= op_x2_5 * to_signed(21326,16) ; -- accx<-accx-a12 . op_x2_5 
    tmp_113 <= tmp_112 + tmp_111 ;
    tmp_114 <= shift_right(tmp_113,14) ; -- accx<-accx >> Lx1 
    x1_5 <= tmp_114(15 downto 0);
    tmp_115 <= op_x1_5 * to_signed(-25627,16) ; -- sn<-sn+C1 . x1_5 
    tmp_116 <= tmp_115 + tmp_90 ;
    -- update state x2_5 of cel 5
    tmp_117 <= e_5 * to_signed(22952,16) ; -- accx<-b2.vn 
    tmp_118 <= op_x2_5 * to_signed(9531,16) ; -- accx<-accx-a22 . op_x2_5 
    tmp_119 <= tmp_118 + tmp_117 ;
    tmp_120 <= op_x1_5 * to_signed(-18319,16) ; -- accx<-accx-a21 . op_x1_5 
    tmp_121 <= tmp_120 + tmp_119 ;
    tmp_122 <= shift_right(tmp_121,14) ; -- accx<-accx >> Lx2 
    x2_5 <= tmp_122(15 downto 0);
    tmp_123 <= op_x2_5 * to_signed(21309,16) ; -- sn<-sn+C2 . x2_5 
    tmp_124 <= tmp_123 + tmp_116 ;
    -- op_x1_5 <- q(x1_5), avec q=(2^-3)/(z-[ 1 - (2^-3) ] )
    ...
    tmp_129<= resize( x1_5 , 20 );
    tmp_130<= resize( op_x1_5 , 20 );
    tmp_131 <= tmp_129 - tmp_130 ;
    i1_5 <= tmp_131 + opi1_5 ;
    tmp_128 <= shift_right(opi1_5,3) ;
    -- op_x2_5 <- q(x2_5), avec q=(2^-3)/(z-[ 1 - (2^-3) ] )
    ...
    tmp_137<= resize( x2_5 , 20 );
    tmp_138<= resize( op_x2_5 , 20 );
    tmp_139 <= tmp_137 - tmp_138 ;
    i1_5 <= tmp_139 + opi1_5 ;
    tmp_136 <= shift_right(opi1_5,3) ;
     -- scale output of cel 5
    -- accumulation of output: tmp_124 of cel 5 with local output: tmp_212
    tmp_213 <= tmp_212 + tmp_124 ;
    ---------------------------------------------
    -- code of cel 6
    ---------------------------------------------
    tmp_141 <= shift_right(tmp_124,3) ; -- vn<-en<<L ,L=-3
    e_6 <= tmp_141(15 downto 0);
    tmp_124= (int_32)0; -- sn<-0,because D=0 
    -- update state x1_6 of cel 6
    tmp_143 <= e_6 * to_signed(23099,16) ; -- accx<-b1.vn 
    tmp_144 <= op_x1_6 * to_signed(7868,16) ; -- accx<-accx-a11 . op_x1_6 
    tmp_145 <= tmp_144 + tmp_143 ;
    tmp_146 <= op_x2_6 * to_signed(8333,16) ; -- accx<-accx-a12 . op_x2_6 
    tmp_147 <= tmp_146 + tmp_145 ;
    tmp_148 <= shift_right(tmp_147,13) ; -- accx<-accx >> Lx1 
    x1_6 <= tmp_148(15 downto 0);
    tmp_149 <= op_x1_6 * to_signed(-20692,16) ; -- sn<-sn+C1 . x1_6 
    tmp_150 <= tmp_149 + tmp_124 ;
    -- update state x2_6 of cel 6
    tmp_151 <= e_6 * to_signed(-13133,16) ; -- accx<-b2.vn 
    tmp_152 <= op_x2_6 * to_signed(5672,16) ; -- accx<-accx-a22 . op_x2_6 
    tmp_153 <= tmp_152 + tmp_151 ;
    tmp_154 <= op_x1_6 * to_signed(-17760,16) ; -- accx<-accx-a21 . op_x1_6 
    tmp_155 <= tmp_154 + tmp_153 ;
    tmp_156 <= shift_right(tmp_155,14) ; -- accx<-accx >> Lx2 
    x2_6 <= tmp_156(15 downto 0);
    tmp_157 <= op_x2_6 * to_signed(20820,16) ; -- sn<-sn+C2 . x2_6 
    tmp_158 <= tmp_157 + tmp_150 ;
    -- op_x1_6 <- q(x1_6), avec q=(2^-3)/(z-[ 1 - (2^-3) ] )
    ...
    tmp_163<= resize( x1_6 , 20 );
    tmp_164<= resize( op_x1_6 , 20 );
    tmp_165 <= tmp_163 - tmp_164 ;
    i1_6 <= tmp_165 + opi1_6 ;
    tmp_162 <= shift_right(opi1_6,3) ;
    -- op_x2_6 <- q(x2_6), avec q=(2^-3)/(z-[ 1 - (2^-3) ] )
    ...
    tmp_171<= resize( x2_6 , 20 );
    tmp_172<= resize( op_x2_6 , 20 );
    tmp_173 <= tmp_171 - tmp_172 ;
    i1_6 <= tmp_173 + opi1_6 ;
    tmp_170 <= shift_right(opi1_6,3) ;
     -- scale output of cel 6
    -- accumulation of output: tmp_158 of cel 6 with local output: tmp_213
    tmp_214 <= tmp_213 + tmp_158 ;
    ---------------------------------------------
    -- code of cel 7
    ---------------------------------------------
    tmp_175 <= shift_right(tmp_158,3) ; -- vn<-en<<L ,L=-3
    e_7 <= tmp_175(15 downto 0);
    tmp_158= (int_32)0; -- sn<-0,because D=0 
    -- update state x1_7 of cel 7
    tmp_177 <= e_7 * to_signed(22729,16) ; -- accx<-b1.vn 
    tmp_178 <= op_x1_7 * to_signed(5623,16) ; -- accx<-accx-a11 . op_x1_7 
    tmp_179 <= tmp_178 + tmp_177 ;
    tmp_180 <= op_x2_7 * to_signed(2051,16) ; -- accx<-accx-a12 . op_x2_7 
    tmp_181 <= tmp_180 + tmp_179 ;
    tmp_182 <= shift_right(tmp_181,13) ; -- accx<-accx >> Lx1 
    x1_7 <= tmp_182(15 downto 0);
    tmp_183 <= op_x1_7 * to_signed(18175,16) ; -- sn<-sn+C1 . x1_7 
    tmp_184 <= tmp_183 + tmp_158 ;
    -- update state x2_7 of cel 7
    tmp_185 <= e_7 * to_signed(1216,16) ; -- accx<-b2.vn 
    tmp_186 <= op_x2_7 * to_signed(821,16) ; -- accx<-accx-a22 . op_x2_7 
    tmp_187 <= tmp_186 + tmp_185 ;
    tmp_188 <= op_x1_7 * to_signed(-20121,16) ; -- accx<-accx-a21 . op_x1_7 
    tmp_189 <= tmp_188 + tmp_187 ;
    tmp_190 <= shift_right(tmp_189,14) ; -- accx<-accx >> Lx2 
    x2_7 <= tmp_190(15 downto 0);
    tmp_191 <= op_x2_7 * to_signed(-21757,16) ; -- sn<-sn+C2 . x2_7 
    tmp_192 <= tmp_191 + tmp_184 ;
    -- op_x1_7 <- q(x1_7), avec q=(2^-3)/(z-[ 1 - (2^-3) ] )
    ...
    tmp_197<= resize( x1_7 , 20 );
    tmp_198<= resize( op_x1_7 , 20 );
    tmp_199 <= tmp_197 - tmp_198 ;
    i1_7 <= tmp_199 + opi1_7 ;
    tmp_196 <= shift_right(opi1_7,3) ;
    -- op_x2_7 <- q(x2_7), avec q=(2^-3)/(z-[ 1 - (2^-3) ] )
    ...
    tmp_205<= resize( x2_7 , 20 );
    tmp_206<= resize( op_x2_7 , 20 );
    tmp_207 <= tmp_205 - tmp_206 ;
    i1_7 <= tmp_207 + opi1_7 ;
    tmp_204 <= shift_right(opi1_7,3) ;
     -- scale output of cel 7
    -- accumulation of output: tmp_192 of cel 7 with local output: tmp_214
    tmp_215 <= tmp_214 + tmp_192 ;
    ----------------------------------------------------------
    -- end of filter, scale global output : tmp_215
    ----------------------------------------------------------
    tmp_216 <= shift_right(tmp_215,14) ;
    output_16 <= tmp_216(15 downto 0);
