...
#include <math.h>
  ...
  int_32_band_stop one_step_16bits_filter_band_stop(int_16_band_stop en_16 , p_16bits_filter_band_stop p_band_stop) {
    ...
    en_32= (int_32_band_stop)en_16;
     /* en<-en .2^0 */
    en_32=( *(coeffs++) )* ( (int_16_band_stop) en_32); /* en<-b0 . en */
    ...
    en_32+=( *(coeffs++) )*x1_16; /* en<-en - a1 . x1 */
    en_32+=( *(coeffs++) )*x2_16; /* en<-en - a2 . x2 */
    tmp_32=en_32>>12; /* vn<-en >> LA */
    tmp_32+=1;
    vn_16=(int_16_band_stop)(tmp_32>>1);
    en_32=( *(coeffs++) )*x1_16; /* en<-b1 . x1 ,because b0=0 */
    en_32+=( *(coeffs++) )*x2_16; /* en<-en +b2 . x2  */
  ...
  /* 6 cels, 5 coeffs:-a2,b2,-a1,b1,b0,  2 states xn_2,xn_1*/
    ...
    *(states++)=0;/* xn_2[1]=0 */
    *(states++)=0;/* xn_1[1]=0 */
    *(coeffs++)=-0.99757781641148457; /* coeffs -a2[2] */
    *(coeffs++)=-0.00206406304882877; /* coeffs +b2[2] */
    *(coeffs++)=1.99713265493134506; /* coeffs -a1[2] */
    *(coeffs++)=0.00210543856042467; /* coeffs +b1[2] */
    *(coeffs++)=0; /* coeffs +b0[2] */
    *(states++)=0;/* xn_2[2]=0 */
    *(states++)=0;/* xn_1[2]=0 */
    *(coeffs++)=-0.99887287015120096; /* coeffs -a2[3] */
    *(coeffs++)=-0.00085524264504578; /* coeffs +b2[3] */
    *(coeffs++)=1.99877654671473581; /* coeffs -a1[3] */
    *(coeffs++)=0.00084614833486400; /* coeffs +b1[3] */
    *(coeffs++)=0; /* coeffs +b0[3] */
    *(states++)=0;/* xn_2[3]=0 */
    *(states++)=0;/* xn_1[3]=0 */
    *(coeffs++)=-0.98779028463552299; /* coeffs -a2[4] */
    *(coeffs++)=0.01106779295389747; /* coeffs +b2[4] */
    *(coeffs++)=1.9872822527273568; /* coeffs -a1[4] */
    *(coeffs++)=-0.01091001735511369; /* coeffs +b1[4] */
    *(coeffs++)=0; /* coeffs +b0[4] */
    *(states++)=0;/* xn_2[4]=0 */
    *(states++)=0;/* xn_1[4]=0 */
    *(coeffs++)=-0.99503104748641791; /* coeffs -a2[5] */
    *(coeffs++)=0.00603234099822480; /* coeffs +b2[5] */
    *(coeffs++)=1.99494722044639383; /* coeffs -a1[5] */
    *(coeffs++)=-0.00605765704775950; /* coeffs +b1[5] */
    *(coeffs++)=0; /* coeffs +b0[5] */
    *(states++)=0;/* xn_2[5]=0 */
    *(states++)=0;/* xn_1[5]=0 */
    *(coeffs++)=-0.97758702450486001; /* coeffs -a2[6] */
    *(coeffs++)=0.02849581905208853; /* coeffs +b2[6] */
    *(coeffs++)=1.9773820863308207; /* coeffs -a1[6] */
    *(coeffs++)=-0.02849286601838938; /* coeffs +b1[6] */
