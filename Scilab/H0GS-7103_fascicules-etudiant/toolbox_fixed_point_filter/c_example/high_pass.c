...
#include <math.h>
  ...
  /* 16 cels, 5 coeffs:-a2,b2,-a1,b1,b0,  2 states xn_2,xn_1*/
    ...
    *(states++)=0;/* xn_2[1]=0 */
    *(states++)=0;/* xn_1[1]=0 */
    *(coeffs++)=-0.99942815234598625; /* coeffs -a2[2] */
    *(coeffs++)=0.00053420994155151; /* coeffs +b2[2] */
    *(coeffs++)=1.9984533603945664; /* coeffs -a1[2] */
    *(coeffs++)=-0.00051268701137752; /* coeffs +b1[2] */
    *(coeffs++)=0; /* coeffs +b0[2] */
    *(states++)=0;/* xn_2[2]=0 */
    *(states++)=0;/* xn_1[2]=0 */
    *(coeffs++)=-0.99829168507035604; /* coeffs -a2[3] */
    *(coeffs++)=0.00385677532304908; /* coeffs +b2[3] */
    *(coeffs++)=1.99733802282672857; /* coeffs -a1[3] */
    *(coeffs++)=-0.00385045270538456; /* coeffs +b1[3] */
    *(coeffs++)=0; /* coeffs +b0[3] */
    *(states++)=0;/* xn_2[3]=0 */
    *(states++)=0;/* xn_1[3]=0 */
    *(coeffs++)=-0.99717516311090493; /* coeffs -a2[4] */
    *(coeffs++)=0.00743011452258467; /* coeffs +b2[4] */
    *(coeffs++)=1.99626226386233019; /* coeffs -a1[4] */
    *(coeffs++)=-0.00763672433197233; /* coeffs +b1[4] */
    *(coeffs++)=0; /* coeffs +b0[4] */
    *(states++)=0;/* xn_2[4]=0 */
    *(states++)=0;/* xn_1[4]=0 */
    *(coeffs++)=-0.99609072025762291; /* coeffs -a2[5] */
    *(coeffs++)=0.00250026191063125; /* coeffs +b2[5] */
    *(coeffs++)=1.99523642415404057; /* coeffs -a1[5] */
    *(coeffs++)=-0.00304985280429095; /* coeffs +b1[5] */
    *(coeffs++)=0; /* coeffs +b0[5] */
    *(states++)=0;/* xn_2[5]=0 */
    *(states++)=0;/* xn_1[5]=0 */
    *(coeffs++)=-0.99505010623690660; /* coeffs -a2[6] */
    *(coeffs++)=-0.01409922576065812; /* coeffs +b2[6] */
    *(coeffs++)=1.99426968565573137; /* coeffs -a1[6] */
    *(coeffs++)=0.01339998088316259; /* coeffs +b1[6] */
    *(coeffs++)=0; /* coeffs +b0[6] */
    *(states++)=0;/* xn_2[6]=0 */
    *(states++)=0;/* xn_1[6]=0 */
    *(coeffs++)=-0.99406456433371615; /* coeffs -a2[7] */
    *(coeffs++)=-0.03607968830402553; /* coeffs +b2[7] */
    *(coeffs++)=1.99337006240047621; /* coeffs -a1[7] */
    *(coeffs++)=0.03563380936270128; /* coeffs +b1[7] */
    *(coeffs++)=0; /* coeffs +b0[7] */
    *(states++)=0;/* xn_2[7]=0 */
    *(states++)=0;/* xn_1[7]=0 */
    *(coeffs++)=-0.99314471540914007; /* coeffs -a2[8] */
    *(coeffs++)=-0.05368755503711131; /* coeffs +b2[8] */
    *(coeffs++)=1.99254442597648951; /* coeffs -a1[8] */
    *(coeffs++)=0.05383279091554045; /* coeffs +b1[8] */
    *(coeffs++)=0; /* coeffs +b0[8] */
    *(states++)=0;/* xn_2[8]=0 */
    *(states++)=0;/* xn_1[8]=0 */
    *(coeffs++)=-0.99230044924226901; /* coeffs -a2[9] */
    *(coeffs++)=-0.05943193346293517; /* coeffs +b2[9] */
    *(coeffs++)=1.99179856043282277; /* coeffs -a1[9] */
    *(coeffs++)=0.06026294152517165; /* coeffs +b1[9] */
    *(coeffs++)=0; /* coeffs +b0[9] */
    *(states++)=0;/* xn_2[9]=0 */
    *(states++)=0;/* xn_1[9]=0 */
    *(coeffs++)=-0.99154082405458610; /* coeffs -a2[10] */
    *(coeffs++)=-0.05031251547931317; /* coeffs +b2[10] */
    *(coeffs++)=1.99113724036782846; /* coeffs -a1[10] */
    *(coeffs++)=0.05166223791140150; /* coeffs +b1[10] */
    *(coeffs++)=0; /* coeffs +b0[10] */
    *(states++)=0;/* xn_2[10]=0 */
    *(states++)=0;/* xn_1[10]=0 */
    *(coeffs++)=-0.99087397500878271; /* coeffs -a2[11] */
    *(coeffs++)=-0.02758427109371943; /* coeffs +b2[11] */
    *(coeffs++)=1.99056432528220739; /* coeffs -a1[11] */
    *(coeffs++)=0.02911605220801153; /* coeffs +b1[11] */
    *(coeffs++)=0; /* coeffs +b0[11] */
    *(states++)=0;/* xn_2[11]=0 */
    *(states++)=0;/* xn_1[11]=0 */
    *(coeffs++)=-0.99030703240877094; /* coeffs -a2[12] */
    *(coeffs++)=0.00450972178468484; /* coeffs +b2[12] */
    *(coeffs++)=1.99008286293423065; /* coeffs -a1[12] */
    *(coeffs++)=-0.00316846852404978; /* coeffs +b1[12] */
    *(coeffs++)=0; /* coeffs +b0[12] */
    *(states++)=0;/* xn_2[12]=0 */
    *(states++)=0;/* xn_1[12]=0 */
    *(coeffs++)=-0.98984605026045447; /* coeffs -a2[13] */
    *(coeffs++)=0.04019006944007766; /* coeffs +b2[13] */
    *(coeffs++)=1.9896951944239272; /* coeffs -a1[13] */
    *(coeffs++)=-0.03932628588501850; /* coeffs +b1[13] */
    *(coeffs++)=0; /* coeffs +b0[13] */
    *(states++)=0;/* xn_2[13]=0 */
    *(states++)=0;/* xn_1[13]=0 */
    *(coeffs++)=-0.98949594578067146; /* coeffs -a2[14] */
    *(coeffs++)=0.07341317852219668; /* coeffs +b2[14] */
    *(coeffs++)=1.98940305404933371; /* coeffs -a1[14] */
    *(coeffs++)=-0.07314981608673123; /* coeffs +b1[14] */
    *(coeffs++)=0; /* coeffs +b0[14] */
    *(states++)=0;/* xn_2[14]=0 */
    *(states++)=0;/* xn_1[14]=0 */
    *(coeffs++)=-0.98926045036242360; /* coeffs -a2[15] */
    *(coeffs++)=0.09885509648301581; /* coeffs +b2[15] */
    *(coeffs++)=1.98920765760232543; /* coeffs -a1[15] */
    *(coeffs++)=-0.09912770403464141; /* coeffs +b1[15] */
    *(coeffs++)=0; /* coeffs +b0[15] */
    *(states++)=0;/* xn_2[15]=0 */
    *(states++)=0;/* xn_1[15]=0 */
    *(coeffs++)=-0.9891420724169184; /* coeffs -a2[16] */
    *(coeffs++)=0.11260587345649742; /* coeffs +b2[16] */
    *(coeffs++)=1.98910977367347885; /* coeffs -a1[16] */
    *(coeffs++)=-0.11319143598106089; /* coeffs +b1[16] */
