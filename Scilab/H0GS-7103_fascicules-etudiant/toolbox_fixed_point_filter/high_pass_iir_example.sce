...
//-------------------------------------------------------------
   clear
   lines(0);funcprot(0);
   rep=get_absolute_file_path("high_pass_iir_example.sce");
   chdir(rep);
//-------------------------------------------------------------
...
//---------------------------------------------------
// 1- HighPass Filter Gabarit in Real Frequencies (Hz))
//---------------------------------------------------
  f0=98; // Low Cut Off Frequency f0 (Hz)
  f1=100; // Hig Cut Off Frequency f1 (Hz)
  G0_db=20*log10(0.01);  // maximum Gain for f<=f0, decibels
  G1_db=20*log10(0.9); // minimum Gain for f>=f1, decibels
//-----------------------------------------------------
// 2- filter model
...
//------------------------------------------------------------------------
  modele_flt="cheb2"; // "butt","cheb1","cheb2","ellip"
//-----------------------------------------------------
...
//------------------------------------------------------
   params.file_name="high_pass"; // will generate toto.c,toto_int.c,toto_float.c
//---------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
   params.name_filter="high_pass"; // specifc functions for this filter will end with _Fz
//--------------------------------------------------------------
...
// 3.1-use of function high_pass_en_p, as for a continuous filter
  [K,F_of_w] = high_pass_en_p(modele_flt,v0,v1,G0_db,G1_db);
